...
class ApiClient {
  ...
  ApiException _handleDioError(DioException error) {
    if (error.type == DioExceptionType.connectionTimeout ||
      ...
      return NetworkException(message: 'Network connection timeout. Please try again.');
    }

    if (error.response == null) {
      return NetworkException(message: 'Unable to connect to the server. Please check your internet connection.');
    }
    ...
    switch (statusCode) {
      ...
      case 500:
      default:
        return ApiException(message: 'Server error: $message', statusCode: statusCode, data: data);
    }
  }
